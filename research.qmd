...
::: {.callout-note .narrow icon="false" collapse="true"}
### "Supreme Supervisors? Building the People's Procuracy, 1949-1961" (2022)

Michael Thompson-Brusstar (2022) [“Supreme Supervisors? Building the People's Procuracy, 1949-1961,”](https://brill.com/view/journals/clsr/6/1/article-p1_001.xml) *China Law and Society Review* 6:1, 1-35.
...
::: {.callout-note .narrow icon="false" collapse="true"}
### "The Anti-Bureaucratic Ghost in China's Bureaucratic Machine" (2021)

Iza Ding & Michael Thompson-Brusstar (2021). [“The Anti-Bureaucratic Ghost in China's Bureaucratic Machine.”](https://www.cambridge.org/core/journals/china-quarterly/article/antibureaucratic-ghost-in-chinas-bureaucratic-machine/89C6C1E8845B167FAE51B498B7EEF3F4) *The China Quarterly*, 248(S1), 116-140.
...
::: {.callout-note .narrow icon="false" collapse="true"}
### "Building Socialist Legality: Political Order and Institutional Development in the Soviet and Chinese Procuracies" (2021)

Margaret Hanson & Michael Thompson-Brusstar (2021) [“Building Socialist Legality: Political Order and Institutional Development in the Soviet and Chinese Procuracies,”](https://www.tandfonline.com/doi/abs/10.1080/09668136.2020.1854185) *Europe-Asia Studies*, 73:1, 157-177.

Why do some attempts to use legal institutions to exert central state control fail, while others succeed? Through a controlled comparison of the Soviet Union (USSR) and the People’s Republic of China (PRC), we analyse the institutionalization of the procuracy, an agency charged with enforcing central legal directives. We show that institutional design, competition, and political support during critical junctures created a positive feedback for the institutionalization of the procuracy in the USSR but left it weak in China. These ﬁndings contribute to our understanding of institutional development, state-building, and authoritarian legal control.
:::

## Ongoing Projects:

::: {.callout-note .narrow icon="false" collapse="true"}
### "Information and Autonomy in Xi’s China : The Case of Central Inspection Teams"
...
::: {.callout-note .narrow icon="false" collapse="true"}
### "Validating Automatic Text Digitization: How to Ensure Quality of Text Analysis Tasks with Automatically Digitized Text Data" (with Blake Miller)
...
::: {.callout-note .narrow icon="false" collapse="true"}
### “Learning by Going Out: Sub-national Diplomacy and Bureaucratic Learning in Reform China” (with James Gethyn Evans)
...
::: {.callout-note .narrow icon="false" collapse="true"}
### "Administrative Reform under Fire: Evidence from China"
...
-   Contributor, ["Xi Won't Go,"](https://www.chinafile.com/conversation/xi-wont-go) ChinaFile, February 25, 2018.
